...
void CFC2() {
	...
	else if (_Fs_ < REG_STATUS_FLAG)
		cpuRegs.GPR.r[_Rt_].UL[0] = VU0.VI[_Fs_].US[0];
	else
	{
...
void CTC2() {
	...
	switch(_Fs_) {
		...
		case REG_STATUS_FLAG:
			VU0.VI[REG_STATUS_FLAG].UL = (VU0.VI[REG_STATUS_FLAG].UL & 0x3F) | (cpuRegs.GPR.r[_Rt_].UL[0] & 0xFC0);
			break;
		case REG_FBRST:
